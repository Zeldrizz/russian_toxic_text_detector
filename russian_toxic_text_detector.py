# -*- coding: utf-8 -*-
"""russian_toxic_detection_beta4_bce.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qQFVyvFl3JkB_42uNhidKz9ka5VD_rxY
...
"""## **Model saving - Сохранение модели**"""

torch.save(model.state_dict(), 'russian_text_classifier_beta4_bce.pth')

"""## **Model loadnig - Загрузка модели**"""

num_labels = 4
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
model = RussianTextClassifier(num_labels).to(device)

model.load_state_dict(torch.load('russian_text_classifier.pth'))
